  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="my-2 p-4 h-auto w-full flex items-center z-10 bg-white flex-col min-h-screen">
        <div className="w-full max-w-[1620px] mx-auto items-center flex flex-col px-6 sm:px-8 md:px-12 lg:px-24 py-7">
          <p className="text-3xl sm:text-4xl md:text-5xl text-center text-[#9A41FF] font-bold break-words">
            Terms of Service
          </p>
        ...
        <div className="text-base sm:text-lg text-left text-[#454545] mb-4 w-full leading-relaxed">
        ...
        <div className="text-base sm:text-lg text-left text-[#454545] mb-4 py-12 sm:py-20 w-full">
